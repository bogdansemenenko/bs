...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/10 20:38:46 by bsemenen          #+#    #+#             */
/*   Updated: 2025/12/11 05:23:27 by bsemenen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void usage(char *msg){
	fprintf(stderr, "Usage: ./client [-p] Password", msg);
	exit(EXIT_FAILURE);
}
